...
<div class="container py-5">
  <div class="row justify-content-center"><div class="col-lg-7"><div class="card hero-card shadow"><div class="card-body p-5">
    ...
    <form method="post">
      ...
      <div class="mt-4 d-flex gap-2"><button class="btn btn-primary">Register</button><a class="btn btn-outline-secondary" href="index.php">Back to Login</a></div>
    </form>
  </div></div></div></div>
</div>
